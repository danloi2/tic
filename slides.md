...
Estás a punto de comenzar un **proceso de transformación profesional**.

Esta guía es tu **brújula estratégica** para pasar de ser un consumidor de tecnología a convertirte en un **arquitecto de experiencias de aprendizaje** con sentido.
...
La asignatura **TIC en Educación Primaria** es el espacio donde aprenderás a **pensar la tecnología** para transformar el aula.

<v-clicks>

- 🎯 **Enfoque**: más allá del manejo instrumental de herramientas
- 🧠 **Centro**: construcción de una mirada crítica, ética y pedagógicamente fundamentada
- 🌐 **Contexto**: la **Sociedad Algorítmica** (Innerarity, 2025)
- 🔑 **Clave**: la mediación pedagógica para una educación con sentido
...
Al completar la asignatura habrás desarrollado:

<v-clicks>

- 🧩 **DigCompEdu A2**: Competencia digital docente en todas sus áreas
- 🤖 **IA ética**: Uso responsable de la Inteligencia Artificial según marcos UNESCO
- 📐 **MRCDD**: Marco de Referencia de la Competencia Digital Docente
- 🌱 **IKD i³**: Aprendizaje · Investigación · Sostenibilidad

</v-clicks>

---

# Los 4 Desafíos de la Asignatura

<v-clicks>

1. **Desafío S** — Comprender la realidad social y tecnológica del aula del siglo XXI
2. **Desafío A** — Diseñar experiencias de aprendizaje inclusivas y con sentido pedagógico
3. **Desafío D** — Construir una identidad docente digital ética y reflexiva
4. **Desafío A** — Seleccionar y aplicar aplicaciones digitales con criterio educativo

</v-clicks>

<!-- Cada desafío conecta con resultados de aprendizaje específicos medibles -->

---

# Resultados de Aprendizaje (RA)

Agrupados por **Dimensiones Profesionales**:

<v-clicks>

- 📚 **RA1** — Conocer el marco teórico de la competencia digital docente
- 🏫 **RA2** — Aplicar el modelo IKD i³ en el diseño de situaciones de aprendizaje
- 🎨 **RA3** — Crear recursos educativos abiertos (REA) con criterios de calidad
- 🤝 **RA4** — Colaborar en equipos para resolver retos interdisciplinares
- 🔍 **RA5** — Evaluar el impacto pedagógico de las TIC en contextos reales
...
- **Bloque 1** — Fundamentos de la Competencia Digital Docente
  - MRCDD, DigCompEdu, Sociedad Algorítmica

- **Bloque 2** — Diseño Pedagógico con TIC
  - DUA, Taxonomía de Bloom Digital, Aprendizaje Cooperativo

- **Bloque 3** — Recursos Educativos Abiertos (REA)
  - Creación, licencias CC, curación de contenidos

- **Bloque 4** — Situaciones de Aprendizaje (SdA)
  - Diseño, desarrollo e implementación interdisciplinar
...
- 🛠️ **Saber Hacer (Práctica)** — Crear, aplicar y compartir recursos reales
...
- 🔬 **Ikerketa** (Investigación) — Actitud investigadora ante la práctica docente
...
1. **Activación** — Conectar con conocimientos previos
2. **Exploración** — Investigar y descubrir el marco teórico
3. **Aplicación** — Crear el producto/artefacto del reto
4. **Compartir** — Presentar y recibir feedback entre pares
5. **Reflexión** — Metaevaluación del propio aprendizaje (DILAN)
...
- 👁️ **Múltiples formas de percepción** — ¿Qué aprender?
...
- 📄 **Informe** — Análisis crítico de la realidad tecnológica educativa
- 🖼️ **Infografía** — Síntesis visual del MRCDD y competencias digitales
- 🎤 **Presentación** — Exposición oral con soporte digital profesional
- 🌐 **Sitio Web** — Espacio digital educativo con identidad propia
- 📚 **Guía Didáctica** — Propuesta pedagógica con integración TIC
- 🎁 **REA** — Recurso Educativo Abierto con licencia Creative Commons
- 🤝 **Decálogo Interdisciplinar** — Trabajo de módulo con Artes, Música y Lengua
...
# Matriz de Coherencia Didáctica

Todo en este curso tiene un **porqué** y un **para qué**:

<v-clicks>

- Cada **actividad** conecta con un **resultado de aprendizaje**
- Cada **resultado de aprendizaje** conecta con una **competencia**
- Cada **competencia** conecta con un **criterio de evaluación**
- Cada **criterio** tiene una **rúbrica** clara y transparente

> Nada es arbitrario: todo tiene un «porqué» social y un «para qué» pedagógico.

</v-clicks>

---

# Alineación con el ODS 4

<v-clicks>

Esta asignatura contribuye directamente al **Objetivo de Desarrollo Sostenible 4**:

- 📖 Educación de Calidad — inclusiva, equitativa y de calidad
- 🌍 Para todos y todas — sin barreras tecnológicas, culturales ni sociales
- 🔮 Con visión de futuro — preparándote para la Sociedad Algorítmica
- 💡 Con herramientas reales — competencias digitales transferibles al aula
...
# Momentos Clave del Feedback

<v-clicks>

- 📥 **Entrega de ficha técnica** → Recepción de comentarios del tutor
- 🔄 **Entrega intermedia** → Retroalimentación formativa entre pares
- ✅ **Entrega final** → Calificación con rúbrica transparente
- 🪞 **DILAN** → Autoevaluación y reflexión metacognitiva
...
# Estructura Temporal del Cuatrimestre

<v-clicks>

- 📅 **Semanas 1-3** — Presentación de la asignatura, retos y formación de grupos
- 📅 **Semanas 4-6** — SdA 1: Fundamentos teóricos y competencia digital
- 📅 **Semanas 7-9** — SdA 2: Diseño pedagógico con TIC y DUA
- 📅 **Semanas 10-12** — SdA 3: Creación del REA y Guía Didáctica
- 📅 **Semanas 13-15** — Presentaciones y entregas finales

</v-clicks>

<!-- Las fechas exactas están disponibles en eGela y en la Tabla 10 de la guía -->
...
- 🚀 **Inicio del reto** — Semana 1: presentación y formación de equipos
- 📋 **Ficha Técnica** — Final de semana 3: entrega de la propuesta inicial
- 🔄 **Entrega intermedia** — Semana 9: revisión por pares con feedback
- 🎤 **Presentaciones orales** — Semanas 13-14: exposición del producto final
- 📤 **Entrega final** — Semana 15: cierre del cuatrimestre en eGela
...
- Evita el exceso de texto en pantalla
- Usa imágenes con sentido pedagógico
...
- ¿Cómo las elimino desde el inicio?
...
## ¡A construir tu horizonte profesional!

[ehu.eus](https://www.ehu.eus) · Daniel Losada · 2026/2027
